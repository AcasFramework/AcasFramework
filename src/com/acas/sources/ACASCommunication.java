...
class ACASCommunication {
	 ...
	 * @param idReceiver
	 * @param extras
	 * @see {@link com.acas.sources.ACASCommunication#send(ACASMessage)} for an advanced use
	 */
	 ...
	 * <p>It's better to use {@link com.acas.sources.ACASCommunication#send(long, String, Bundle)}</p>
	 * 
	 * @param message
	 * @see {@link com.acas.sources.ACASCommunication#send(long, String, Bundle)}
	 */
	 ...
	 * @param messageId
	 * @param extras
	 * @see {@link com.acas.sources.ACASCommunication#broadcast(ACASMessage)} for an advanced use
	 */
	 ...
	 * <p>It's better to use {@link com.acas.sources.ACASCommunication#broadcast(long, Bundle)}</p>
	 * 
	 * @param message
	 * @see {@link com.acas.sources.ACASCommunication#broadcast(long, Bundle)}
	 */
